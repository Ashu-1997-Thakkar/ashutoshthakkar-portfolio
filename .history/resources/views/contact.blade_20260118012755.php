            ...
            <div class="col-lg-5" data-aos="fade-right" data-aos-duration="1200">
                ...
                <div class="glass-card-modern gradient-border-card mb-4">
                    ...
                    <div class="stats-mini d-flex gap-4 pt-3 border-top" style="border-color: rgba(79, 70, 229, 0.2) !important;">
                        ...
                        <div>
                            <div class="fw-bold" style="color: #EC4899; font-size: 1.5rem;">2+</div>
            ...
            error: function(xhr, status, error) {
                ...
                if (xhr.status === 422) {
                    ...
                    if (xhr.responseJSON && xhr.responseJSON.errors) {
                        ...
                        let errorList = '<ul style="margin: 10px 0; padding-left: 20px;">';
                ...
                formMessage.html(`
                    <div class="alert-error">
                        ...
                        <br><small style="opacity: 0.8; margin-top: 10px; display: block;">
                            Error Code: ${xhr.status} | Status: ${status}
                        </small>
                    </div>
                `).fadeIn();
