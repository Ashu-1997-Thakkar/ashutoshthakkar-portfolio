...
<body>
    ...
    <script>
        ...
        function applyLightTheme() {
            ...
            root.style.setProperty('--dark-secondary', '#F3F4F6');
            ...
            document.querySelectorAll('.glass-card-modern').forEach(card => {
                ...
                card.style.borderColor = 'rgba(79, 70, 229, 0.15)';
            });
            
            // Update navbar
            document.querySelector('.navbar-modern').style.background = 'rgba(255, 255, 255, 0.9)';
