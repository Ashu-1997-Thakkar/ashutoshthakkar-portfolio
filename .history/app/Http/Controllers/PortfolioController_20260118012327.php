...
class PortfolioController extends Controller
{
    ...
    {
        try {
            // Email template content for you
            $emailBody = "
            ...
            Mail::send([], [], function($message) use ($data, $autoReplyBody) {
                $message->to($data['email'], $data['name'])
                        ->subject('Thank you for contacting me!')
                        ->setBody($autoReplyBody, 'text/html')
                        ->from('ashnandani123@gmail.com', 'Ashutosh Nandani');
            });
